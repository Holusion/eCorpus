 ...
 */
 ...
 export default class SceneCard extends i18n(LitElement)
 {
    ...
    protected render() :TemplateResult {
      let explorer = `/ui/scene/${encodeURIComponent(this.name)}?lang=${this.language.toUpperCase()}`;
      let story = `/ui/scene/${encodeURIComponent(this.name)}/edit?lang=${this.language.toUpperCase()}`;
