...
<section class="section">
    ...
    <a href="https://web.archive.org/web/20251112051708/https://www.musee-moyenage.fr/activites/expositions/expositions-passees/exposition-merveilleux-tresor-d-oignies.html">Pour en savoir plus sur l'exposition Merveilleux Trésor d'Oignies : Éclats du 13e siècle</a>
    ...
    {% include voyager.html url=scene_url title="Reliquaire de la côte de saint Pierre" abstract="Hugo d'Oignies, Reliquaire de la côte de saint Pierre, circa 1238, (FRB. Dépôt SAN, inv. TO5)." class="h-100 larg100" %}
